 ...
 * @author Trisha
 */
public class SearchMaintenenceExpiredCars extends javax.swing.JFrame {
...
model.setRowCount(0);
        ...
        for (UberCar car : uberCars) {
            System.out.println("Car date: " + car.getMaintenanceExpDate());
            if (car.getMaintenanceExpDate().before(date)) {
    ...
    /**
     * Creates new form SearchMaintenenceExpiredCars
     */
    public SearchMaintenenceExpiredCars() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Expired By Today: ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchMaintenenceExpiredCars.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
